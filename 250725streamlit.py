...
#streamlit run e:\250725div_app\250725streamlit.py
...
with col1:
        ...
        image=Image.open(r'E:\250725div_app\data250725re\IMG241103_115831.jpg')
        
        #streamlitﾆimageｦ渡す
        st.image(image,width=400)
        
        image=Image.open(r'E:\250725div_app\data250725re\IMG241103_115854.jpg')
        st.image(image,width=400)
        
        image=Image.open(r'E:\250725div_app\data250725re\IMG241103_115947.jpg')
        st.image(image,width=400)
        
        #動画をupする
        #video_file=open('744_640x360.mov','rb')
#        video_file=open(r'E:\250725div_app\data250725re\DSC231123_(3).mp4')
...
#        st.video(r'E:\250725div_app\data_250725\DSC231123.mp4')
#       st.video(r'E:\250725div_app\data_250725\VID250511.mp4')
...
#        st.text(f'趣味: {hobby1}')
with col2:    
        image=Image.open(r'E:\250725div_app\data250725re\IMG250514_1356.jpg')
        st.image(image,width=400)
